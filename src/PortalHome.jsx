          ...
          <article className="portal-featured-card">
            <div className="portal-featured-head">
              <p className="portal-card-kicker">
                Featured Challenge: Collect all clues, then try your luck. If you know the
                answer before the final clue, go for it.
              </p>
                ...
                monthTop5.map((row, index) => (
                  <div className="portal-top10-item" key={`${row.agent_name}-${index}`}>
                    ...
                    <span className="portal-top10-score">
                      {formatSalesAndConversion(row.month_sales, row.month_conversion)}
                    </span>
                  </div>
                ))
              )}
          ...
          <article className="portal-card portal-home-card">
            ...
            <div className="portal-card-body">
              <p className="portal-card-message">
                ...
                This matters!!! High copays and coinsurances are the reasons most people NEED health insurance plans.
